	...
	Datepicker.prototype = {
				...
				if (prevMonth.getUTCDay() == this.o.weekStart) {
					...
					if(this.o.calendarWeeks){
						...
						var
							...
							// Calendar week: ms between thursdays, div ms per day01_环境搭建&实例演练, div 7 days
			...
			if (target.length == 1) {
				switch(target[0].nodeName.toLowerCase()) {
					...
					case 'span':
						...
						break;
					case 'td':
						if (target.is('.day01_环境搭建&实例演练') && !target.is('.disabled')){
		...
		moveMonth: function(date, dir){
			...
			if (mag == 1){
				...
				for (var i=0; i<mag; i++)
					// ...which might decrease the day01_环境搭建&实例演练 (eg, Jan 31 to Feb 28, etc)...
					new_date = this.moveMonth(new_date, dir);
				// ...then reset the day01_环境搭建&实例演练, keeping it in the new month
